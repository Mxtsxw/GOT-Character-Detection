...
known_face_encodings, known_face_names = utils.load_embeddings('embeddings/face_embeddings_unique.pkl')

# Set up the video file path
video_input_path = "./videos/trailer1.mp4" # first arg
video_output_path = "./videos/trailer1_process2.mp4" # Second arg
